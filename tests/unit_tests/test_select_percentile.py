...
import os
from si.feature_selection.select_percentile import SelectPercentile  # Update import path as needed
...
class TestSelectPercentile(TestCase):
    ...
    def test_transform(self):
        ...
        #check that the number of features is roughly the expected percentile
